...
data/
    ...
    Empirical_Predicted_Rank_Difference.mat
    Empirical_Spectral_Gradient_Anes_Awake.mat
    ...
    Predicted_Spectral_Gradient_Anes.txt
    Predicted_Spectral_Gradient_Anes_Awake.mat
    Predicted_Spectral_Gradient_Awake.txt
    Receptor.mat
...
│          validation_code.m
│
├─One_dimensional_axis
│      One_dimensional_Axis_Code.m
│
...
##### 2_second_step
1. 1Cal_posterior_probability.m
2. 2Retain_matrix.m
3. data_array2_40area.m
4. data_array_40area.m
5. trans_matrix_40area.m
##### 3_validation
1. cal_roc.m
2. matrix_sort.m
3. validation_code.m
#### One_dimensional_axis
1. One_dimensional_Axis_Code.m
#### Structure_dimensionality_reduction
